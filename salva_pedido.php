...
$forma_pagamento = $_POST['inlineRadioOptions'];
$id_compra = uniqid(NULL, true);
$status = "Pendente";
$result = mysqli_query($conectar,"INSERT INTO clientes (nome,telefone,endereco,ponto_referencia,bairro,numero_casa) VALUES ('$nome','$numero','$endereco','$pontoReferencia','$bairro','$numeroCasa')");
...
%0a".$textopedido."%0d%0a%0d%0a*Forma de pagamento%3a*%20 ".$forma_pagamento."%0d%0a%0d%0a*Valor
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="display:none">
        <a  href="https://api.whatsapp.com/send?phone=5582991431836&text=<?php echo $texto?>" class="btn btn-success btn-lg btn-block" style="color: white;" id="whatsapp"><i class="fa fa-whatsapp" style="font-size:36px;color:white" ></i> ENVIAR</a>
      </div>
