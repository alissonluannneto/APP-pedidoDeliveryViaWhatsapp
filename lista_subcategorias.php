<?php
  ...
  $resultado=mysqli_query($conectar,"SELECT * FROM subcategorias ORDER BY 'id'");
      ...
      <?php 
        while($linhas = mysqli_fetch_array($resultado)){
          echo "<tr>";
            ...
            <a href='edita_subcategorias.php?&id=<?php echo $linhas['id']; ?>'><button type='button' class='btn  btn-warning'>Editar</button></a>   
