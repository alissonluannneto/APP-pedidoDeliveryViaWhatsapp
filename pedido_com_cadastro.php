...
$pontoReferencia = $_SESSION['pontoReferencia'];
$bairro = $_SESSION['bairro'];
$numeroCasa = $_SESSION['numeroCasa'];
?>
<!doctype html>
<html lang="pt-br">
  <head>
...
<main role="main" class="container">
  ...
  <div class="card-body">
    <?php 
       ...
       <strong>Usuário Cadastrado!</strong> Você já têm cadastro! é só finalizar a compra.
       </div>";
    	}

    ?>
    <form class="form-signin" method="POST" action="salva_pedido_cadastro.php" >
    <div class="form-group">
    <label for="exampleFormControlInput1">Nome:</label>
    <input type="text" required="required" class="form-control" placeholder="nome" name="nome" value="<?php echo$nome?>">
  </div>

  <div class="form-group">
    <label for="exampleFormControlInput1">celular:</label>
    <input type="text" required="required" class="form-control" placeholder="Ex. 82- 9.9191-8181" value="<?php echo$_GET['numero']?>" name="numero">
  </div>
  

  <div class="form-group">
    <label for="exampleFormControlTextarea1">Endereço:</label>
    <textarea class="form-control" required="required" rows="3" name="endereco"><?php echo$endereco?></textarea>
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlInput1">Nº:</label>
    <input type="text" required="required" class="form-control" placeholder="Ex. Apat. 22 ou Bloco 11 ou 22"  name="numeroCasa" value="<?php echo$numeroCasa?>">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlInput1">Bairro:</label>
    <input type="text" required="required" class="form-control" placeholder="Ex. Ponta verde"  name="bairro" value="<?php echo$bairro ?>">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlInput1">Ponto de referência:</label>
    <input type="text" required="required" class="form-control" placeholder="Ex. proxímo ao restaurante janga"  name="pontoReferencia" value="<?php echo$pontoReferencia?>">
  </div>
   
  
          <div class="form-group">
        <label for="exampleFormControlSelect1">Selecione a forma de pagamento:</label>
        <select class="form-control" id="inlineRadio1" name="forma_pg">
               ...
               require("conexao.php");
                ...
                foreach($_SESSION['carrinho'] as $id => $qtd){
                        ...
                        $total += $ln['preco'] * $qtd;
                         echo "
              <tr>  
                <td><img  src='$foto' class='circle' width=100 height=100</td>
                <td>$nome</td>
                <td>$qtd</td>
                <td>R$$preco</td>
                <td>R$ $sub</td>
